...
function ProductCard(props) {
    ...
    return (
        <div className="grid grid-cols-3 mb-5 mx-auto md:flex-row md:max-w-6xl bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div className='flex flex-col justify-center items-center'>
                <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={dish.photo} alt="" />
                {!addToCart &&
                    <div className='mt-3'>
                ...
                {addToCart &&
                    <div class="flex items-center">
                        <button class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-l focus:outline-none focus:shadow-outline" onClick={decrement}>-</button>
                        <h4  class="text-center w-16 py-2 border-t border-b border-gray-200 focus:outline-none" > {count} </h4>
                        <button class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-r focus:outline-none focus:shadow-outline" onClick={increment}>+</button>
                    </div>}
            </div>
        </div>
    )
